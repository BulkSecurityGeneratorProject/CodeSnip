...
public class RatingResource {
     ...
     * or with status 500 (Internal Server Error) if the ratingDTO couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/ratings")
    @Timed
    ...
    @GetMapping("/ratings")
    @Timed
    public ResponseEntity<List<RatingDTO>> getAllRatings(@ApiParam Pageable pageable)
